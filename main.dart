...
// URL do JSON público (GitHub raw ou qualquer URL pública)
// Altere para a sua URL real
...
class VpnServer {
  ...
  final String protocol; // SSH / WEBSOCKET / HTTP
  ...
  String get flagEmoji {
    // Converte código de país para bandeira usando regional indicator symbols
...
class VpnState extends ChangeNotifier {
  ...
  Future<void> _connect() async {
    ...
    // Simula handshake (substitua pela lógica real de tunnel SSH/WS)
    await Future.delayed(const Duration(seconds: 2));

    // TODO: Integrar biblioteca de tunnel real (ex: dartssh2, flutter_vpn)
    // Por agora simula conexão bem-sucedida
    _status = VpnStatus.connected;
    _ip = '197.${Random().nextInt(255)}.${Random().nextInt(255)}.${Random().nextInt(255)}';
    _startTimer();
    _simulateTraffic();
    notifyListeners();
  }
  ...
  void _simulateTraffic() {
    // Remove em produção — substitua por stats reais do tunnel
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          // Stats row (visible só quando conectado)
                  ...
                  itemBuilder: (_, i) {
                    ...
                    return _ServerTile(
                      ...
                      onTap: () {
                        ...
                        // close overlay via overlay entry
                      },
                    );
                  },
                ),
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: selected ? AppColors.accent.withOpacity(0.6) : AppColors.glassBorder,
          ),
        ),
        child: Row(
          children: [
...
// ─────────────────────────────────────────────
//  NEURAL NETWORK PAINTER (BACKGROUND)
// ─────────────────────────────────────────────
